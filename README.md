[![Run App PatrickGurney](https://github.com/Patrooblious/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/Patrooblious/GithubActions/actions/workflows/run-app.yaml)
